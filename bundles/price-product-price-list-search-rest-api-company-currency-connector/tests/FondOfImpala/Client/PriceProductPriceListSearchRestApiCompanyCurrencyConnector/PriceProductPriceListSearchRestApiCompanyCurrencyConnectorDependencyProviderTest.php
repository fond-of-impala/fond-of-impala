...
class PriceProductPriceListSearchRestApiCompanyCurrencyConnectorDependencyProviderTest extends Unit
{
    ...
    /**
     * @var \FondOfImpala\Client\PriceProductPriceListSearchRestApiCompanyCurrencyConnector\PriceProductPriceListSearchRestApiCompanyCurrencyConnectorDependencyProvider
     */
    ...
    public function testProvideServiceLayerDependencies(): void
    {
        ...
        static::assertInstanceOf(
            PriceProductPriceListSearchRestApiCompanyCurrencyConnectorToZedRequestClientInterface::class,
            $container[PriceProductPriceListSearchRestApiCompanyCurrencyConnectorDependencyProvider::CLIENT_ZED_REQUEST],
        );
    }
}
