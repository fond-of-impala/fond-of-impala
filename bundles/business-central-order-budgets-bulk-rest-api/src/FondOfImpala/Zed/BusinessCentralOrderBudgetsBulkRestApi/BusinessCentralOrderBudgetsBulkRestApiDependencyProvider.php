...
namespace FondOfImpala\Zed\BusinessCentralOrderBudgetsBulkRestApi;
...
class BusinessCentralOrderBudgetsBulkRestApiDependencyProvider extends AbstractBundleDependencyProvider
{
    /**
     * @var string
     */
