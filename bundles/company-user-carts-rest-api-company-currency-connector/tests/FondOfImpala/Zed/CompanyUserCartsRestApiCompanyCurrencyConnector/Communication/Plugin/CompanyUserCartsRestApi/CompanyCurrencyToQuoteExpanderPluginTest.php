...
namespace FondOfImpala\Zed\CompanyUserCartsRestApiCompanyCurrencyConnector\Communication\Plugin\PermissionExtension;

use ArrayObject;
use Codeception\Test\Unit;
use FondOfImpala\Zed\CompanyUserCartsRestApiCompanyCurrencyConnector\Communication\CompanyUserCartsRestApiCompanyCurrencyConnectorCommunicationFactory;
use FondOfImpala\Zed\CompanyUserCartsRestApiCompanyCurrencyConnector\Communication\Plugin\CompanyUserCartsRestApi\CompanyCurrencyToQuoteExpanderPlugin;
...
{
    /**
     * @var \FondOfImpala\Zed\CompanyUserCartsRestApiCompanyCurrencyConnector\Communication\Plugin\CompanyUserCartsRestApi\CompanyCurrencyToQuoteExpanderPlugin
     */
    protected CompanyCurrencyToQuoteExpanderPlugin $plugin;

    /**
     * @var \FondOfImpala\Zed\CompanyUserCartsRestApiCompanyCurrencyConnector\Communication\CompanyUserCartsRestApiCompanyCurrencyConnectorCommunicationFactory|\PHPUnit\Framework\MockObject\MockObject
     */
    protected CompanyUserCartsRestApiCompanyCurrencyConnectorCommunicationFactory|MockObject $factoryMock;

    /**
     * @var \FondOfImpala\Zed\CompanyUserCartsRestApiCompanyCurrencyConnector\Dependency\Facade\CompanyUserCartsRestApiCompanyCurrencyConnectorToCurrencyFacadeInterface|\PHPUnit\Framework\MockObject\MockObject
     */
    protected CompanyUserCartsRestApiCompanyCurrencyConnectorToCurrencyFacadeInterface|MockObject $currencyFacadeMock;
    ...
    protected function _before(): void
    {
        ...
        $this->factoryMock = $this->getMockBuilder(CompanyUserCartsRestApiCompanyCurrencyConnectorCommunicationFactory::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->currencyFacadeMock = $this->getMockBuilder(CompanyUserCartsRestApiCompanyCurrencyConnectorToCurrencyFacadeInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
