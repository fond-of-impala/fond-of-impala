...
class PriceProductConcretePriceListWritePublisherPluginTest extends Unit
{
    ...
    protected PriceProductConcretePriceListWritePublisherPlugin $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new PriceProductConcretePriceListWritePublisherPlugin();
    ...
    public function testHandleBulk(): void
    {
        ...
        $this->facadeMock->expects(static::atLeastOnce())
            ->method('publishConcretePriceProductPriceList')
