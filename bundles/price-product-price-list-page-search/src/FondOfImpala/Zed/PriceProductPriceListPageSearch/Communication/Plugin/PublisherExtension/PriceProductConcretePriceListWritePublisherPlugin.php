 ...
 */
class PriceProductConcretePriceListWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
    ...
    public function handleBulk(array $eventEntityTransfers, $eventName): void
    {
        ...
        $this->getFacade()->publishConcretePriceProductPriceList($eventTransferIds);
    }
