...
use Orm\Zed\PriceProductPriceListPageSearch\Persistence\Map\FoiPriceProductAbstractPriceListPageSearchTableMap;
...
class PriceProductAbstractPriceListPageSynchronizationDataPlugin extends AbstractPlugin implements SynchronizationDataBulkRepositoryPluginInterface
{
    ...
    protected function createFilterTransfer(int $offset, int $limit): FilterTransfer
    {
        return (new FilterTransfer())
            ->setOffset($offset)
            ->setLimit($limit)
            ->setOrderBy(FoiPriceProductAbstractPriceListPageSearchTableMap::COL_ID_PRICE_PRODUCT_ABSTRACT_PRICE_LIST_PAGE_SEARCH);
    }
}
