...
class DocumentTypeErpDeliveryNoteToZedRequestClientBridgeTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfImpala\Client\DocumentTypeErpDeliveryNote\Dependency\Client\DocumentTypeErpDeliveryNoteToZedRequestClientBridge
     */
    protected DocumentTypeErpDeliveryNoteToZedRequestClientBridge $zedRequestClientBridge;
    ...
    protected function _before(): void
    {
        ...
        $this->zedRequestClientBridge = new DocumentTypeErpDeliveryNoteToZedRequestClientBridge(
