...
class NotifyApprovedByRoleErpOrderCancellationMailTypePluginTest extends Unit
{
    ...
    protected NotifyApprovedByRoleErpOrderCancellationMailTypePlugin $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new NotifyApprovedByRoleErpOrderCancellationMailTypePlugin();
