...
class NotifyRejectedErpOrderCancellationPostTransactionPluginTest extends Unit
{
    ...
    protected NotifyRejectedErpOrderCancellationPostTransactionPlugin $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new NotifyRejectedErpOrderCancellationPostTransactionPlugin();
    ...
    public function testPostTransaction(): void
    {
        ...
        $this->facadeMock->expects(static::once())
            ...
            ->willReturnCallback(static function (ErpOrderCancellationMailConfigTransfer $configTransfer) use ($self) {
                $self->assertEquals($configTransfer->getType(), NotifyRejectedErpOrderCancellationMailTypePlugin::MAIL_TYPE);
