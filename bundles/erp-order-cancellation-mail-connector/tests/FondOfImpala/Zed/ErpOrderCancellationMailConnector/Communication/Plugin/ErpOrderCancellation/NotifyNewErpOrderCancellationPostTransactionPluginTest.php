...
class NotifyNewErpOrderCancellationPostTransactionPluginTest extends Unit
{
    ...
    protected NotifyNewErpOrderCancellationPostTransactionPlugin $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new NotifyNewErpOrderCancellationPostTransactionPlugin();
    ...
    public function testPostTransaction(): void
    {
        ...
        $this->facadeMock->expects(static::once())
            ...
            ->willReturnCallback(static function (ErpOrderCancellationMailConfigTransfer $configTransfer) use ($self) {
                $self->assertEquals($configTransfer->getType(), NotifyReadyErpOrderCancellationMailTypePlugin::MAIL_TYPE);
