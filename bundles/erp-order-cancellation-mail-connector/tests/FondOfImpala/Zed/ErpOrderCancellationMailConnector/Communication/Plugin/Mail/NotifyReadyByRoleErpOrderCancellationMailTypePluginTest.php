...
class NotifyReadyByRoleErpOrderCancellationMailTypePluginTest extends Unit
{
    ...
    protected NotifyReadyByRoleErpOrderCancellationMailTypePlugin $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new NotifyReadyByRoleErpOrderCancellationMailTypePlugin();
    ...
    {
        $this->assertEquals(NotifyReadyErpOrderCancellationMailTypePlugin::MAIL_TYPE, $this->plugin->getName());
    }
    ...
    public function testBuild(): void
    {
        ...
        $this->mailBuilderMock->expects(static::once())
            ...
            ->willReturnCallback(static function (string $subject) use ($self) {
                static::assertEquals(sprintf('%s.subject', NotifyReadyErpOrderCancellationMailTypePlugin::MAIL_TYPE), $subject);
