...
class NotifyReadyErpOrderCancellationMailTypePluginTest extends Unit
{
    ...
    protected NotifyReadyErpOrderCancellationMailTypePlugin $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new NotifyReadyErpOrderCancellationMailTypePlugin();
