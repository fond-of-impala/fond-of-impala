 ...
 * @type {string}
 */
const selectIdPath = '#price-dimension-price-list';

$(document).ready(function () {

    let selectedValue = parseInt(getUrlParam(priceDimensionParam + "[idPriceList]", 0));
    ...
    function addNewParamsToUrl() {
        ...
        $(selectIdPath + " option:selected").each(function () {
            ...
            url = removeParam(priceDimensionParam + "[idPriceList]", url);
            url = updateUrl(url, priceDimensionParam + "[idPriceList]", $(this).val());
        });
