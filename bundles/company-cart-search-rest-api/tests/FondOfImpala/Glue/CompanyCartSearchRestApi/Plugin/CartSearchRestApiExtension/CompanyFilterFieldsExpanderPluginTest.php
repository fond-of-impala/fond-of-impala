...
class CompanyFilterFieldsExpanderPluginTest extends Unit
{
    ...
    /**
     * @var \FondOfImpala\Glue\CompanyCartSearchRestApi\Plugin\CartSearchRestApiExtension\CompanyFilterFieldsExpanderPlugin
     */
    ...
    public function testExpand(): void
    {
        ...
        static::assertEquals(CompanyCartSearchRestApiConstants::FILTER_FIELD_TYPE_COMPANY_UUID, $filterFieldTransfer->getType());
