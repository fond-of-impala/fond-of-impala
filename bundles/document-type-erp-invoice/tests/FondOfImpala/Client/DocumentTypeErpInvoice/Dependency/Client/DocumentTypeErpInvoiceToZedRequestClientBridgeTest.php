...
class DocumentTypeErpInvoiceToZedRequestClientBridgeTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfImpala\Client\DocumentTypeErpInvoice\Dependency\Client\DocumentTypeErpInvoiceToZedRequestClientBridge
     */
    protected DocumentTypeErpInvoiceToZedRequestClientBridge $zedRequestClientBridge;
    ...
    protected function _before(): void
    {
        ...
        $this->zedRequestClientBridge = new DocumentTypeErpInvoiceToZedRequestClientBridge(
