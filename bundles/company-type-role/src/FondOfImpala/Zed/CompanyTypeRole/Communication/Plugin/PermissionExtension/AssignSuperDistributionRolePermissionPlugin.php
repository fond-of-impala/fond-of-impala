 ...
 */
class AssignSuperDistributionRolePermissionPlugin extends AbstractPlugin implements PermissionPluginInterface
{
    /**
     * @var string
     */
    public const KEY = 'AssignSuperDistributionRolePermission';
