    ...
    public function testMapRestProductListsBulkAssignmentToRestProductListsBulkRequestAssignment(): void
    {
        ...
        $this->restProductListsBulkRequestAssignmentTransferMock->expects(static::atLeastOnce())
            ...
            ->with(
                static::callback(
                    fn (
                        RestProductListsBulkRequestAssignmentCustomerTransfer $restProductListsBulkRequestAssignmentCustomerTransfer
                    ): bool => $restProductListsBulkRequestAssignmentCustomerTransfer->getCustomerReference() === $data['customer_reference']
                ),
