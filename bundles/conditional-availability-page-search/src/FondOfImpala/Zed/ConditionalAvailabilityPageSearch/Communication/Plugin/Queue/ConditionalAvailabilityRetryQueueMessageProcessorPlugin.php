 ...
 */
class ConditionalAvailabilityRetryQueueMessageProcessorPlugin extends AbstractPlugin implements QueueMessageProcessorPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->getEventFacade()->forwardMessages($queueMessageTransfers);
    }
