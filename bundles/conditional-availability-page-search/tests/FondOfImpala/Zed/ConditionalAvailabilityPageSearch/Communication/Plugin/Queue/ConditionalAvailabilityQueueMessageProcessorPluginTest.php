...
class ConditionalAvailabilityQueueMessageProcessorPluginTest extends Unit
{
    ...
    protected ConditionalAvailabilityQueueMessageProcessorPlugin $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new ConditionalAvailabilityQueueMessageProcessorPlugin();
