...
namespace FondOfImpala\Client\DocumentTypeErpOrder\Dependency\Client;
...
class DocumentTypeErpOrderToZedRequestClientBridgeTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfImpala\Client\DocumentTypeErpOrder\Dependency\Client\DocumentTypeErpOrderToZedRequestClientBridge
     */
    protected DocumentTypeErpOrderToZedRequestClientBridge $zedRequestClientBridge;
    ...
    protected function _before(): void
    {
        ...
        $this->zedRequestClientBridge = new DocumentTypeErpOrderToZedRequestClientBridge(
